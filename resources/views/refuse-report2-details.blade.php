...
@section('content')
    ...
    <div class="breadcrumb mt-4 mb-4">
        ...
        <a class="link-breadcrumb" href="report-mangement.html">إدارة البلاغات</a>
        <img class="h-24 me-3 ms-3" src="{{'webimage/icon-breadcrumb.png'}}" alt="no-icon">
        <span class="fs-14 fw-400 text-secondary">اسم البلاغ</span>
    </div>
    <div class="card-border mt-16">
        <div class="d-flex justify-content-between flex-wrap">
            <h5 class="text-primary">نوع البلاغ</h5>
        </div>
        <hr class="hr-card">
        <div class="row">
            <div class="col-12">
                <div class="card-details">
                    ...
                    <p class="text-secondary2 fs-14 fw-400 lh-lg">
                        ...
                        رقم
                        5، حيث لاحظ الفريق أن درجة الحرارة في بعض الغرف تتجاوز المعدلات الطبيعية، مما أدى إلى شكاوى من
                        الموظفين والمستخدمين. بعد فحص النظام، تبين أن بعض الوحدات بحاجة إلى صيانة فورية. تم الاتصال
                        بفريق
                        الصيانة وتم اتخاذ الإجراءات اللازمة لإصلاح الأعطال، حيث تم استبدال الفلاتر وتنظيف الوحدات. </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mb-3">
                    <div class="card-refuse">
                        <div class="d-flex">
                            <img class="h-24" src="image/warning-triangle.png" alt="no-image">
                            <div class="w-100">
                                <h6 class="text-primary">سبب رفض البلاغ</h6>
                                <hr class="hr-card">
                            </div>
                        </div>
                        <p class="text-secondary fs-14 mb-2">معلومات غير كافية – لم يتم تقديم تفاصيل كافية لمعالجة
                            البلاغ.
                            يرجى توضيح المشكلة وإعادة الإرسال.</p>
                    </div>
                </div>
            </div>
        </div>
